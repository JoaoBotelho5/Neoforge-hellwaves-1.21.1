...
public class SoulCageItem extends Item {
    ...
    private InteractionResult releaseGuardian(ItemStack stack, ServerLevel level, Player player, Vec3 spawnPos) {
        ...
        if (!cageData.contains("GuardianData")) {
            return InteractionResult.FAIL;
        }

        // Create a new Guardian
        ZombieGuardian guardian = HWDeferredRegister.ZOMBIE_GUARDIAN.get().create(level);
        if (guardian == null) {
            return InteractionResult.FAIL;
        }

        guardian.setRestoringFromCage(true);
        ...
        if (cageData.contains("GuardianLevel")) {
            guardian.setGuardianLevel(cageData.getInt("GuardianLevel"));
        }
        ...
        guardian.setRestoringFromCage(false);

        // Add guardian to world
        level.addFreshEntity(guardian);

        // Replace full Soul Cage in hand with empty Soul Cage
        ...
        if (player.getMainHandItem() == stack) {
            ...
            // fallback: add to inventory / drop
        ...
        player.displayClientMessage(
                Component.literal("§aGuardian released! Level: " + guardian.getGuardianLevel()),
                true
        );
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (customData != null) {
            ...
            if (cageData.contains("GuardianLevel")) {
                ...
                tooltip.add(Component.literal("§6Guardian Level: " + guardianLevel));
    ...
    public Component getName(ItemStack stack) {
        ...
        if (customData != null) {
            ...
            if (cageData.contains("GuardianLevel")) {
                ...
                return Component.literal("Soul Cage §7(Level " + level + ")");
            }
        }
